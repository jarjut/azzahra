              ...
              <nav class="primary-nav">
                <div class="clearfix nav-wrapper">
                  ...
                  <!-- Mini Profile // only visible in Tab and Mobile -->
                    ...
                    @if (Auth::guest())
                      <li class="loginsidenav"><a href="{{route('login')}}"><i class="fa fa-user fa-fw"></i>Login</a>
                      </li>
                      <li class="loginnav"><a id="loginpopover" href="#" class="menu-smooth-scroll"><i class="fa fa-user fa-fw"></i>Login</a>
                      </li>
                      <div id="loginContent" class="webui-popover-content" style="min-width:255px;">
                        <form action="{{ route('login') }}" method="post">
                          {{ csrf_field() }}
                          <div class="input-field grey-text text-darken-1">
                            <input id="emailpopup" class="validate" type="email" name="email" required autofocus>
                            <label for="emailpopup">Email</label>
                          </div>
                          <div class="input-field grey-text text-darken-1">
                            <input id="passwordpopup" type="password" name="password" required>
                            <label for="passwordpopup">Password</label>
                          </div>
                          <p>
                            <input type="checkbox" class="filled-in" id="rememberpopup" name="remember" />
                            <label for="rememberpopup">Remember Me</label>
                          </p>
                    ...
                    @else
                      <li><a href="{{ route('logout') }}" class="menu-smooth-scroll" onclick="event.preventDefault();
                  ...
                  <ul id="dropdown1" class="inline-menu submenu-ul dropdown-content">
                    @if (Route::currentRouteName()=="home")
                      <li><a href="{{ route('service') }}" >Layanan</a>
                      </li>
