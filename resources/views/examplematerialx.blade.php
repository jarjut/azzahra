            ...
            <div class="nav-inner">
              <nav class="primary-nav">
                <div class="clearfix nav-wrapper">
                  <a href="#home" class="left brand-logo menu-smooth-scroll" data-section="#home"><img src="materialx/example/images/logo.png" alt="">
                    </a>
                    ...
                    <li class="mobile-profile">
                      <div class="profile-inner">
                        <div class="pp-container">
                          <img src="materialx/example/images/person.png" alt="">
                        </div>
                        <h3>John Doe</h3>
          ...
          <div class="clearfix about-inner">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="person-about">
                ...
                <p>Hello, I’m a UI/UX Designer &amp; Front End Developer from Victoria, Australia. I hold a master degree of Web Design from the World University. <br /> And scrambled it to make a type specimen book. It has survived not only five centuries</p>
            ...
            <div class="col-sm-6 col-md-4">
              <div class="person-img wow fadeIn">
                <img class="z-depth-1" src="materialx/example/images/person.png" alt="">
              </div>
            </div>
            <!-- about me image -->
    ...
    <section id="portfolio" class="scroll-section root-sec white portfolio-wrap">
      ...
      <div id="portfolioModal" class="modal white">
        ...
        <div class="modal-footer">
          <a href="http://bdinfosys.com/demo/?item=materialx" target="_blank" class="waves-effect btn-flat brand-text modal-action">Live Demo</a>
